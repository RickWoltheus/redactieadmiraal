...
class __TwigTemplate_0a9c0a09473cf65330fd54782b4ed7a4ccd14691f3de787374d13a5ca3b08c20 extends Twig_Template
{
...
";
    ...
    ";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["media"]) ? $context["media"] : null), "user://plugins/seo/twitter.png", array(), "array"), "resize", array(0 => 50, 1 => 50), "method"), "url", array(), "method"), "html", null, true);
    ...
    <div class=\"SummaryCardContainer\"> <div class=\"SummaryCard\">
        ...
        // line 13
        echo twig_escape_filter($this->env, ((isset($context["base_url_absolute"]) ? $context["base_url_absolute"] : null) . $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "header", array()), "twittershareimg", array())), "html", null, true);
        echo "\" width=\"100%\">
    <div class=\"cardtext\">
    ...
    {
        return array (  161 => 55,  147 => 54,  144 => 53,  141 => 52,  138 => 51,  135 => 50,  118 => 49,  113 => 48,  111 => 47,  108 => 46,  105 => 45,  103 => 44,  91 => 35,  72 => 19,  68 => 18,  63 => 16,  57 => 13,  50 => 10,  48 => 9,  45 => 8,  31 => 6,  28 => 5,  24 => 3,  22 => 2,  19 => 1,);
    }
...
{% endif %}
    ...
    {% set context = admin.page(true) %}
    <div class=\"tweetcontainer\"><div class=\"tweet-card\"> <div class=\"tweethead\"> <img src=\"{{ media['user://plugins/seo/twitter.png'].resize(50, 50).url() }}\" width=\"50\" height=\"50\" class=\"twitterimg\"> <span class=\"twitterusername\">Twitter team <br><span class=\"twitternick\">@twitter</span></span> </div><blockquote class=\"twitter-tweet\"> 
    <p class=\"twittcontent\"> Here is how this page will looks once shared on twitter. </p>
    <div class=\"SummaryCardContainer\"> <div class=\"SummaryCard\">
         <img id=\"twittliveimg\" src=\"{{ base_url_absolute ~ context.header.twittershareimg }}\" width=\"100%\">
    <div class=\"cardtext\">
         <h2 class=\"cardtitle\" id=\"titletwtarget\">
    ...
    {% endif %}
", "forms/fields/twitter/twitter.html.twig", "C:\\wamp64\\www\\school\\jaar3\\redactieadmiraal\\grav\\user\\plugins\\seo\\templates\\forms\\fields\\twitter\\twitter.html.twig");
    }
}
