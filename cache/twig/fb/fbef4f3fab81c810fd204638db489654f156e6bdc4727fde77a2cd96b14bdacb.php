...
class __TwigTemplate_927f157a3e81f7f38897a9b02dd0d69eead1ed3e30da12c8f4d5673dad5ef477 extends Twig_Template
{
...
";
  ...
  <div class=\"header\">
    ...
    <img class=\"co-logo\" src=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["media"]) ? $context["media"] : null), "user://plugins/seo/logofacebook.jpg", array(), "array"), "resize", array(0 => 50, 1 => 50), "method"), "url", array(), "method"), "html", null, true);
        echo "\" />
...
\$('#fbimgselect').on('click', function() {
   \$('.js__media-element').on('click', function() {
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                ...
                if ($this->getAttribute($context["field"], "type", array())) {
                    ...
                    // line 222
                    echo "                ";
                    $this->loadTemplate(array(0 => (((("forms/fields/" . $this->getAttribute($context["field"], "type", array())) . "/") . $this->getAttribute($context["field"], "type", array())) . ".html.twig"), 1 => "forms/fields/text/text.html.twig"), "forms/fields/facebook/facebook.html.twig", 222)->display($context);
                    // line 223
                    echo "            ";
                }
                // line 224
    ...
    {
        return array (  342 => 225,  328 => 224,  325 => 223,  322 => 222,  319 => 221,  316 => 220,  299 => 219,  294 => 218,  292 => 217,  289 => 216,  286 => 215,  284 => 214,  274 => 207,  90 => 26,  86 => 25,  82 => 24,  70 => 22,  60 => 15,  55 => 13,  50 => 10,  48 => 9,  45 => 8,  31 => 6,  28 => 5,  24 => 3,  22 => 2,  19 => 1,);
    }
...
{% endif %}
  ...
  <div class=\"header\">
    <div class=\"options\"><i class=\"fa fa-chevron-down\"></i></div>
    <img class=\"co-logo\" src=\"{{ media['user://plugins/seo/logofacebook.jpg'].resize(50, 50).url() }}\" />
    <div class=\"co-name\"><a href=\"#\">Facebook Team</a></div>
...
\$('#fbimgselect').on('click', function() {
   \$('.js__media-element').on('click', function() {
    ...
    {% endif %}
", "forms/fields/facebook/facebook.html.twig", "C:\\wamp64\\www\\school\\jaar3\\redactieadmiraal\\grav\\user\\plugins\\seo\\templates\\forms\\fields\\facebook\\facebook.html.twig");
    }
}
